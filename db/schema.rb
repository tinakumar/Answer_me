...
ActiveRecord::Schema.define(version: 20131017203834) do
  ...
  add_index "questions_users", ["user_id", "question_id"], name: "index_questions_users_on_user_id_and_question_id"
